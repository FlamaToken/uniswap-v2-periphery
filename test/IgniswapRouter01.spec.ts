...
enum RouterVersion {
  IgniswapRouter01 = 'IgniswapRouter01',
  IgniswapRouter02 = 'IgniswapRouter02'
}

describe('IgniswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.IgniswapRouter01]: fixture.router01,
        [RouterVersion.IgniswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IgniswapRouter01]: 101876,
              [RouterVersion.IgniswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IgniswapRouter01]: 138770,
              [RouterVersion.IgniswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
